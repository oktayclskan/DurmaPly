<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminPanel.Master" AutoEventWireup="true" CodeBehind="GameAdd.aspx.cs" Inherits="DurmaPly.AdminPanel.GameAdd" %>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div>
                            ...
                            <div class="mb-3">
                                <asp:LinkButton ID="btn_GameAdd" runat="server" CssClass="btn btn-success d-block" OnClick="btn_GameAdd_Click">Ekle</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
