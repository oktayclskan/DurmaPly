<%@ Page Title="" Language="C#" MasterPageFile="~/UserPanel/UserPanel.Master" AutoEventWireup="true" CodeBehind="Gta5.aspx.cs" Inherits="DurmaPly.UserPanel.Gta5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <video class="video w-100 h-100 mb-3" src="Video/y2mate.com - Grand Theft Auto V and Grand Theft Auto Online for PS5 and Xbox Series XS  Coming March 2022_1080p_Trim.mp4" autoplay muted />
    </div>
    <div class="container text-light">
        <div class="contentDesc">
            <div class="row">
                <div class="col-xl-6">
                    <h3>Escape From Tarkov Standard Edition</h3>
                </div>
                <div class="col-xl-6">
                    <div class="row">
